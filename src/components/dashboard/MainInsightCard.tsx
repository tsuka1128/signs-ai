        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 animate-glow">
            <div className="flex items-center gap-5">
                <div className="flex flex-col items-center gap-0.5 min-w-[64px]">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">全体体温</span>
                </div>
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1.5">
                        <Badge className="bg-teal/10 text-teal font-black">{title}{title === "全社" ? "" : "向け"}</Badge>
