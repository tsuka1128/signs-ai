    ...
    return (
        <>
            ...
            <div className="w-full bg-white rounded-xl border border-slate-100 shadow-sm relative">
                ...
                {/* 生産性ロジックの解説ヘルプ (通常時) */}
                <div className="absolute top-3 left-3 flex items-center gap-1.5 text-[9px] text-slate-400 font-bold uppercase tracking-tight z-10 group/regular-help">
                    <div className="relative">
                        <button className="w-3.5 h-3.5 rounded-full bg-slate-100 text-slate-400 group-hover/regular-help:bg-slate-200 group-hover/regular-help:text-slate-500 flex items-center justify-center text-[9px] font-black cursor-help transition-colors select-none">?</button>
                        <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 text-white p-3.5 rounded-xl shadow-xl text-[10px] leading-relaxed break-normal whitespace-normal hidden group-hover/regular-help:block z-[100] normal-case tracking-normal animate-in fade-in zoom-in-95">
                            ...
                            <div className="text-slate-300">
                                ...
                                そこに<span className="font-bold text-white">組織体温（無理をしていないか）</span>を掛け合わせることで、部署を同列のY軸で比較評価します。
                            </div>
                        </div>
                    </div>
                    <span className="opacity-60">生産性ロジック</span>
                </div>
