...
export function LaborFinanceSection({ 
    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            {/* セクション⑤：AIアクション提言 */}
            <div className="bg-white rounded-[2.5rem] p-10 text-slate-800 border border-slate-100 shadow-sm relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 opacity-[0.06] group-hover:opacity-10 transition-opacity text-slate-900">
                    <Coins className="w-32 h-32" />
                </div>

                <div className="relative z-10 space-y-8">
                    <div className="flex items-center gap-3">
                        <div className="px-3 py-1 bg-teal-50 rounded-full text-[10px] font-black uppercase tracking-[0.2em] text-teal-600 border border-teal-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                            {alertDepts.length > 0 && (
                                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-4">
                                    ...
                                    <div className="space-y-1">
                                        <div className="text-xs font-black text-rose-600 uppercase tracking-widest">警告域：高単価・低体温</div>
                            ...
                            {cautionDepts.length > 0 && (
                                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-4">
                                    <span className="text-lg">🟡</span>
                                    <div className="space-y-1">
                                        <div className="text-xs font-black text-amber-600 uppercase tracking-widest">要注意：投資不足リスク</div>
                                        <div className="text-sm font-bold text-slate-700">
                            ...
                            {idealDepts.length > 0 && (
                                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-4">
                                    <span className="text-lg">🟢</span>
                                    <div className="space-y-1">
                                        <div className="text-xs font-black text-teal-600 uppercase tracking-widest">理想的：高効率維持中</div>
                                        <div className="text-sm font-bold text-slate-700">
