  ...
  slides: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "table",
          headers: ["業務領域", "AI影響度", "ポイント"],
          rows: [
            ["労務管理", "85%", "給与計算70%削減事例多数"],
            ["採用業務", "75%", "スカウト自律化が進行中"],
            ["人材育成", "50%", "個別最適化が進展"],
            ["評価・配置", "40%", "最終判断は人間"],
            ["🎯 組織開発・人事戦略", "10%", "★ Signs AI の主戦場 ★"],
          ],
        },
        {
          type: "callout",
          tone: "accent",
          title: "あなたのHRはどちら側か？",
          text: "AIで消える85%側か、AIで強くなる10%側か。Signs AIは「組織開発・人事戦略」——AIが補助に留まる唯一の領域を主戦場にする。（出典：シゴトAI 2026年版・経産省・Gallup等）",
        },
      ],
    },
    {
