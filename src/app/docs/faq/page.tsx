            ...
            <section className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <FaqItem
                        ...
                        question="招待リンクが無効と表示されます"
                        answer="招待リンク(URL)は一度使用すると無効になります。管理者から届いた招待リンク(URL)をそのまま開いてください。招待情報はリンクから自動で反映されるため、手入力は不要です。うまく開けない場合は、URLが途中で切れていないか、期限切れになっていないかを確認し、必要に応じて管理者に新しい招待を発行してもらってください。"
                    />
                    <FaqItem
                        id="faq-change-dept"
                        question="所属部署を変更したい"
            ...
            <section className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <FaqItem
                        ...
                        answer="同月内に再度回答したい場合は、回答完了画面の案内に従って再入力してください。なお、以前の回答は残った状態で、新しい回答が追加される形で扱われます。"
                    />
                    <FaqItem
                    ...
                    />
                    <FaqItem
                        id="faq-survey-minlength"
                        question="自由記述の最低文字数（20字以上）に達しません"
                        answer="自由記述は20字以上の入力をお願いしています。この欄には、日々の業務で感じたことや気になること、改善のアイデアなどを自由に書いてください。「最近◯◯が大変だった」「△△の進め方を変えたら良さそう」など、具体的なエピソードや気持ちをそのまま書くと自然と20字を超えます。"
                    />
                </div>
            </section>
