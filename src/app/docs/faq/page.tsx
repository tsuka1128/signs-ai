    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <section className="space-y-6">
                ...
                <div className="space-y-4">
                    <FaqItem
                        ...
                        answer="Signs AI にログインした状態でアクセスしてください。ログイン状態であれば、自動的にあなたの企業のフォームが表示されます。ログアウトしている場合は、先にログインしてからアクセスしてください。"
                    />
                    <FaqItem
                    ...
                    <FaqItem
                        ...
                        question="100文字以上の記述が書けません"
                        answer="Step 3の「KPI改善に関する記述」は、AIが組織の課題を分析するための重要なインプットです。具体的なエピソードや改善提案を含めると、自然と100文字を超えます。"
                    />
                </div>
            </section>
            ...
            <div className="pt-10 border-t border-slate-100 flex items-center justify-between">
                <Link href="/docs/growth-steps" className="flex items-center gap-2 text-slate-400 hover:text-slate-600 transition-all font-bold group">
