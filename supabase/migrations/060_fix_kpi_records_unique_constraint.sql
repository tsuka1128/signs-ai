...
-- axis_id が NULL の場合（基本軸）も考慮されます
ALTER TABLE kpi_records ADD CONSTRAINT kpi_records_full_unique UNIQUE(kpi_definition_id, recorded_month, department_id, axis_id);
